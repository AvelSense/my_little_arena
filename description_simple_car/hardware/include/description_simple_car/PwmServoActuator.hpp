#ifndef DESCRIPTION_SIMPLE_CAR__SIMPLE_WHEEL_SYSTEM_HPP_
#define DESCRIPTION_SIMPLE_CAR__SIMPLE_WHEEL_SYSTEM_HPP_
...
#endif  // DESCRIPTION_SIMPLE_CAR__PWM_SERVO_ACTUATOR_HPP_